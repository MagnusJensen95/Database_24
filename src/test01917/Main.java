...
public class Main {
	public static void main(String[] args) {
		...
		OperatoerDTO operatoerDTO = new OperatoerDTO(5, "Plebnus", "PN", "12121991-1212", "suckitfrantsen");
		try{
			...
			for(OperatoerDTO e : liste){
				System.out.println("Id: "+e.getOprId()+" & navn: "+e.getOprNavn()+" & ini: "+e.getIni()+" & pass: "+e.getPassword());
			}
		} catch (DALException e){
			e.printStackTrace();
		}
